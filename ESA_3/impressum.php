    ...
    <div class="wrapper">
        ...
        <div class="banner">
            <div class="overlay">
                ...
                <div class="spacer">
                    <h1 class=" wowload fadeInLeft">Impressum</h1>
                    <h5 class="  wowload fadeInRight">Die Verantwortlichen</h5>
                </div><!-- ENDE spacer -->
        ...
        <div class="start">
            ...
            <div class="row">
                ...
                <?php
                // EINBINDEN PHP-Klasse mit Verantwortlichen
                require_once "classes/Verantwortliche.class.php";
                require_once "classes/Verantwortliche_Adapter.class.php";
                ?>
                ...
                <div class="col-sm-5 wowload fadeInLeft">
                    <div class="spacer">
                        <!-- Objekt aus Adapter-Klasse generieren -->
                        <?php
                        $verantwortliche_Person_2 = new Verantwortliche_ergaenzt(new Verantwortliche("images/Muppet_02.png", "Salim", "Oussayfi", "Chief Operator"), "797754", "oussayfi@gmail.com");
                        $verantwortliche_Person_2->ausgebenVerantwortliche();
                        ?>
                    </div><!-- ENDE spacer -->
                ...
                <div class="col-sm-5 wowload fadeInRight">
                    <div class="spacer">
                        <!-- Objekt aus Adapter-Klasse generieren -->
                        <?php
                        $verantwortliche_Person_1 = new Verantwortliche_ergaenzt(new Verantwortliche("images/Muppet_01.png", "Manuel", "Bogus", "Chief Operator"), "791563", "chaostype@gmx.de");
                        $verantwortliche_Person_1->ausgebenVerantwortliche();
                        ?>
                    </div><!-- ENDE spacer -->
                ...
                <div class="col-sm-5 wowload fadeInLeft">
                    <div class="spacer">
                        <!-- Objekt aus urspruenglicher Klasse generieren -->
                        <?php
                        $Praktikant_1 = new Verantwortliche("images/piggy.jpg", "Maxi", "Musterfrau", "Praktikantin");
                        $Praktikant_1->ausgebenDaten();
                        ?>
                    </div><!-- ENDE spacer -->
                </div><!-- ENDE col-sm-3 wowload fadeInLeft -->
