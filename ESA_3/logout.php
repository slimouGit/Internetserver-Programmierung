<?php
    ...
    session_start();
    //--------------------------------------------------------------------------------------------------------
    //Uberpruefen, ob eine Session aufgebaut ist
    if(isset($_SESSION["benutzername"])) {
        //Session wird beendet
        session_destroy();
        //Weiterleitung nach erfolgreichem ausloggen nach 3 Sekunden zur Startseite
...
<?php
    //falls nicht eingeloggt, wird auf Startseite weitergeleitet
    } else
        {
