...
<html>
    <head>
        ...
        <meta name="description"      content="ESA_2_ISP">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5 wowload fadeInLeft">
                            <div class="spacer">
                                <!-- Objekt generieren -->
                                <?php   
                                    $person1 = new Verantwortliche("images/Muppet_01.png", "Manuel", "Bogus", "Chief Operator", "791563", "chaostype@gmx.de");
                                    $person1->impressum_Person();  
                                ?>      
                            </div><!-- ENDE spacer -->
                        ...
                        <div class="col-sm-5 wowload fadeInRight">
                            <div class="spacer">
                                <!-- Objekt generieren -->
                                <?php   
                                    $person2 = new Verantwortliche("images/Muppet_02.png", "Salim", "Oussayfi", "Chief Operator", "797754", "oussayfi@gmail.com");
                                    $person2->impressum_Person(); 
                                ?> 
                            </div><!-- ENDE spacer --> 
