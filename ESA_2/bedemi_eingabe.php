<?php
    ...
    $datenbankVerbindung = new Nutzerdatenbank("slimou.de.mysql","slimou_de","slimou_de","26041980");
    session_start();
                        ...
                        <div class="col-sm-8 wowload fadeInRight">
                            <div class="spacer">
                                <div class="eintrag_erfolgreich">
                                    ...
                                    <?php echo $datenbankVerbindung->eintragenDatensaetze($fehler, $verfasser_vorname , $verfasser_nachname ,
                                          $email , $vorname , $nachname , $job ,  $ort ,  $headline ,  $kommentar ,
                                          $bewertung ,  $image ); ?>
                                </div>
                            </div><!-- ENDE spacer --> 
                                ...
                                <div class="wowload fadeInRightBig">  
                                    ...
                                    <form name="kontakt" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="form" enctype="multipart/form-data">
                                        ...
                                        echo "<div class=\"auswahl_Angaben\">Angaben zu der Person, die Du bewerten möchtest</div>";
                                            ...
                                            $form->form_Image("füge ein Bild hinzu", "userfile", "$image", "$imageErr");
...
<?php
   ...
   {
    //falls gar nicht eingeloggt, wird auf Fehlerseite weitergeleitet
