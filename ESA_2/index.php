                            ...
                            <div class="spacer">  
                                <form name="login" id="login_Formular" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="form" >
                                        ...
                                        echo "<div class=\"auswahl_Angaben\">Login</div>";
                                            ...
                                            $form->form_Field("Benutzername", "benutzername", "$benutzername","$benutzernameErr");
                                            $form->form_Password("Passwort", "passwort", "$passwort", "$passwortErr");
                                    ...
                                    <?php include 'includes/verarbeite_login.php'; ?>
                            </div><!-- ENDE spacer --> 
...
<!-- Login-Formular ein-/ausblenden, abhaengig von Status ser Session -->
<?php 
